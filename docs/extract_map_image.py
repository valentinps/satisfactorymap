#!/usr/bin/env python3
# Fuses the game's own 4-corner sliced map render into a single map_highres.png
# in the repo root. These tiles are the actual textures the game's in-game map
...
#
# Usage: py docs/extract_map_image.py [path/to/extraction/Content]
#
...
OUTPUT_FILE = Path(__file__).parent.parent / "map_highres.png"
